	...
	<div class="parallax">
        ...
        <br><br>
            ...
            <div class="card" style="width:650px;">
              <div class="card-body">
                <h4 class="card-title">Atualizar Disciplina</h4>               
                  <form action="ServletDisciplina?cmd=atu" method="post">                     
                    <div class="form-inline" style="text-align: center; ">
                      <label style="padding:20px">Codigo da Disciplina:</label>
                      <input type="text" class="form-control" name="idDisciplina" style="width:100px;" required required>
                    </div>                        
                    <br>                                                                
