				...
				<div class="card" style="width: 650px;">
					<div class="card-body">
						...
						<form action="ServletQuestao" method="get">
							<input type="hidden" name="cmd" value="filtrarQuestoes"> <br />
							<div class="form-group" style="text-align: left">
								<label>Curso:</label><br> <select id="idCurso"
								...
								<select
									name="idDisciplina" class="form-control"
									aria-label="Default select example">
								...
								<br>
								 <label>Ano:</label><br> <select
									name="anoQuestao" class="form-control"
									aria-label="Default select example">
																		<option selected value="">Selecione um ano</option>

									<%
                                QuestaoDao daoquestoes = new QuestaoDao();
    							List <String> listaano = new ArrayList<String>();
    							listaano = (ArrayList)daoquestoes.todosAnos();
    							for(String a: listaano){%>
