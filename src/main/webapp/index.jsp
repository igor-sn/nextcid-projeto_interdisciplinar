...
<body>
	...
	<div class="parallax">
        ...
        <section class="home">
            <h3>
                <b>Bem vindo ao sistema de gerenciamento de Provas do ENADE</b>
            </h3>
            <br>
            <h5 style="text-align:center">
                <b>Acesse o menu lateral para visualizar as opções de gerenciamento </b>
            </h5>
        </section>
