...
<title>Nextcid | Atualização de Curso </title>
</head>
<!-- id = # / class = . -->
        ...
        <div class="row">
          <div class="col-sm-8">
            <div class="card" style="height: auto;">
              <div class="card-body">
                <h4 class="card-title">Atualização de Curso</h4>
                <jsp:useBean id="curso" scope="session" class="br.edu.unicid.bean.Curso" />
                <form action="ServletCurso?cmd=atualizar" method="post">                     
                  <div class="form-group">
                    <label>Codigo:</label>
                    <input type="text" class="form-control" name="idCurso" value="<%= curso.getIdCurso() %>" readonly="readonly"><br>
                    <label>Nome do Curso:</label>
                    <input type="text" class="form-control" required name="nomeCurso" value="<%= curso.getNomeCurso() %>"><br>						
