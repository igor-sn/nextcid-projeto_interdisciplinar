...
<title>Nextcid | Cadastrar Curso</title>
</head>
<!-- id = # / class = . -->
            ...
            <div class="card" style="width:650px;">
              <div class="card-body">
                ...
                <input type="hidden" name="cmd" value="incluir"> <br/>  
    							...
    							int maiorId = daocurso.maiorID();
    							%>
                  <div class="form-group">

                                    
                    <label>Codigo:</label>
                    <input readonly class="form-control" name="idCurso" size="60" maxlength="60" value = "<%=maiorId + 1%>"><br>
                    <label>Nome:</label>
                    <input type="text" required class="form-control" name="nomeCurso" size="60" maxlength="60"
                    ><br>					
                  </div>                                                                                       
