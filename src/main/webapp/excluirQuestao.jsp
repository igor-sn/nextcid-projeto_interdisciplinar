...
<title>Nextcid | Excluir Questão</title>
</head>
<!-- id = # / class = . -->
        ...
        <div class="row">
          <div class="col-sm-8">
            <div class="card" style="height: auto;">
              <div class="card-body">
                <h4 class="card-title">Excluir Questão</h4>
                <form action="ServletQuestao?cmd=exc" method="post">                     
                  <div class="form-inline">
                    <label style="padding:20px">Codigo da Questão:</label>
                    <input type="text" class="form-control" name="idQuestao" size="10" maxlenght="10" required>
                  </div>                        
                  <br>                                                                
