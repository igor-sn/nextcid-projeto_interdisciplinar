...
<title>Nextcid | Cadastro de Questão Dissertativa</title>
</head>
<!-- id = # / class = . -->
		...
		<div class = "wrapper " style = "min-height : 850px;">
			...
			<div class="container" style="width: 890px;">
				...
				<div class="card" style="width: 650px;">
					<div class="card-body">
						<h4 class="card-title">Cadastro de Questão Dissertativa</h4>
						<form action="ServletQuestao" method="get">
							<input type="hidden" name="cmd" value="incluirDiss"> <br />
							<input type="hidden" name="tpQuestao" value="Dissertativa">
							<br />
							...
							<div class="form-group" style="text-align: left">
								...
								<label>Codigo:</label> <input readonly class="form-control"
									...
									value="<%=maiorId + 1%>"><br> <br> <label>Edição:</label>
								...
								<textarea class="form-control" name="enunciado"
									required placeholder="Questão : A prova do ENADE acontece em alguns periodos .........."></textarea>
								...
								<textarea class="form-control" required name="respDiss"
									placeholder="Resposta : A prova do ENADE acontece em alguns periodos .........."></textarea>
								<br> <label>Curso:</label><br> <select name="idCurso"
    							...
    							for(Disciplina a: listadisciplina){%>
                                    ...
                                    %>
								</select> <br> <label>Disciplina 2:</label><br> <select
