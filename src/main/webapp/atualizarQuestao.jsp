...
<title>Nextcid | Atualizar Questao</title>
</head>
<!-- id = # / class = . -->
	...
	<div class="parallax">
        ...
        <br><br>
            ...
            <div class="card" style="width:650px;">
              <div class="card-body">
                <h4 class="card-title">Atualizar Questão</h4>               
                  <form action="ServletQuestao?cmd=atu" method="post">                     
                    <div class="form-inline" style="text-align: center; ">
                      <label style="padding:20px">Codigo da Questão:</label>
                      <input type="text" class="form-control" name="idQuestao" style="width:100px;" required required>
                    </div>                        
                    <br>                                                                
