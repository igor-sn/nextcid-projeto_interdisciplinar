...
<title>Nextcid | Consultar Curso</title>
</head>
<!-- id = # / class = . -->
        ...
        <div class="col-sm-8">
          <div class="card" style="height: auto;">
            <div class="card-body">
              ...
              <jsp:useBean id="curso" scope="session" class="br.edu.unicid.bean.Curso" />
              <form action="ServletCurso?cmd=atualizar" method="post">                                  
                <div class="form-group">
                  <label>Codigo:</label>
                  <input type="text" class="form-control" name="idCurso" size="60" maxlength="60"
                  value="<%=curso.getIdCurso()%>" readonly="readonly"><br>
                  <label>Nome do Curso:</label>
                  <input type="text" class="form-control" name="nomeCurso" size="60" maxlength="60"
                  value="<%=curso.getNomeCurso()%>" readonly="readonly"><br>	                       
                </div>                       
                <br>                                                               
