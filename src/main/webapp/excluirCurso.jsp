...
<title>Nextcid | Excluir Curso</title>
</head>
<!-- id = # / class = . -->
        ...
        <div class="row">
          <div class="col-sm-8">
            <div class="card" style="height: auto;">
              <div class="card-body">
                <h4 class="card-title">Excluir Curso</h4>
                <form action="ServletCurso?cmd=exc" method="post">                     
                  <div class="form-inline">
                    <label style="padding:20px">Codigo do Curso:</label>
                    <input type="text" class="form-control" name="idCurso" size="10" maxlenght="10" required>
                  </div>                        
                  <br>                                                                
