...
<title>Nextcid | Excluir Disciplina</title>
</head>
<!-- id = # / class = . -->
        ...
        <div class="row">
          <div class="col-sm-8">
            <div class="card" style="height: auto;">
              <div class="card-body">
                <h4 class="card-title">Excluir Disciplina</h4>
                <form action="ServletDisciplina?cmd=exc" method="post">                     
                  <div class="form-inline">
                    <label style="padding:20px">Codigo da Disciplina:</label>
                    <input type="text" class="form-control" name="idDisciplina" size="10" maxlenght="10" required>
                  </div>                        
                  <br>                                                                
