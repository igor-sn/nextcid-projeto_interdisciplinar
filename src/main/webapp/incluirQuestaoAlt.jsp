...
<title>Nextcid | Cadastro de Questão Objetiva</title>
</head>
<!-- id = # / class = . -->
		...
		<div class = "wrapper " style = "min-height : 850px;">
			...
			<div class="container" style="width: 890px;">
				...
				<div class="card" style="width: 650px;">
					<div class="card-body">
						<h4 class="card-title">Cadastro de Questão Objetiva</h4>
						<form action="ServletQuestao" method="get">
							<input type="hidden" name="cmd" value="incluirAlt"> <br />
							<input type="hidden" name="tpQuestao" value="Objetiva">
							<br />

							<%
                                QuestaoDao daoquestao = new QuestaoDao();
    							int maiorId = daoquestao.maiorID();
    							%>
							<div class="form-group" style="text-align: left">


								<label>Codigo:</label> <input readonly class="form-control"
									name="idQuestao" size="60" maxlength="60"
									value="<%=maiorId + 1%>"><br> <br> <label>Ano:</label>
								<input type="text" required class="form-control" name="anoQuestao"
									size="60" maxlength="60"><br>
								<label>Número da Questão:</label> <input type="text"
									class="form-control"  required name="nQuestao" size="60" maxlength="60"><br>
								<label>Enunciado:</label>
								<textarea class="form-control" required name="enunciado"
									placeholder="Questão : A prova do ENADE acontece em alguns periodos .........."></textarea>
								<br> <label>Colocar Imagem:</label> <input type="file"
									class="form-control-file" name="img" accept="image/*"><br>
								<label>Alternativa A:</label> <input type="text"
									class="form-control" required name="altA" size="60"><br>
								<label>Alternativa B:</label> <input type="text"
									class="form-control"  required name="altB" size="60"><br>
								<label>Alternativa C:</label> <input type="text"
									class="form-control" required name="altC" size="60"><br>
								<label>Alternativa D:</label> <input type="text"
									class="form-control" required name="altD" size="60" ><br>
								<label>Alternativa E:</label> <input type="text"
									class="form-control" required name="altE" size="60"><br>
								<label>Gabarito:</label><br> <select name="respAlt"
									...
									<option selected value="A">E</option>
								</select> 
								<br> 
								...
								<select id="idCurso"
									name="idCurso"  class="form-control"
								 aria-label="Default select example">

									<option selected value=0>Selecione um curso
										</option>
									<%
                                CursoDao daocurso = new CursoDao();
    							List <Curso> listacurso = new ArrayList<Curso>();
    							listacurso = (ArrayList)daocurso.todosCursos();
    							for(Curso a: listacurso){%>

									<option value=<%=a.getIdCurso()%>><%=a.getNomeCurso()%></option>
								...
								</select> <br> <label>Disciplina 1:</label><br> <select
									name="idDisciplina1" class="form-control"
									aria-label="Default select example">
									<option selected value=0>Selecione uma disciplina
										</option>
								...
								</select> <br> <label>Disciplina 2:</label><br> 
								
								<select
									name="idDisciplina2" class="form-control"
									aria-label="Default select example">
									<option selected value=0>Selecione uma disciplina
										</option>
									<%
    							for(Disciplina a: listadisciplina){%>
                                    ...
                                    %>
								</select> <br> <label>Disciplina 3:</label><br> <select
									name="idDisciplina3" class="form-control"
									aria-label="Default select example">
									<option selected value=0>Selecione uma disciplina
										</option>
									<%
    							for(Disciplina a: listadisciplina){%>
                                    ...
                                    %>
								</select> <br> <label>Disciplina 4:</label><br> <select
									name="idDisciplina4" class="form-control"
									aria-label="Default select example">
									<option selected value=0>Selecione uma disciplina
										</option>
									<%
