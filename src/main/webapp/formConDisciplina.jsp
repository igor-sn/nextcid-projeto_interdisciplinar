...
<title>Nextcid | Consultar Disciplina</title>
</head>
<!-- id = # / class = . -->
      ...
      <div class="row">
        <div class="col-sm-8">
          <div class="card" style="height: auto;">
            <div class="card-body">
              <h4 class="card-title">Consultar Diciplina</h4>
              <jsp:useBean id="disciplina" scope="session" class="br.edu.unicid.bean.Disciplina" />
              <form action="ServletDiciplina?cmd=atualizar" method="post">                                  
                  <div class="form-group">
                    <label>Codigo:</label>
                    <input type="text" class="form-control" name="idDisciplina" value="<%= disciplina.getIdDisciplina() %>" readonly="readonly"><br>
                    <label>Nome da Disciplina:</label>
                    <input type="text" class="form-control" name="nomeDisciplina" value="<%= disciplina.getNomeDisciplina() %>"><br>
                    <label>Curso Relacionado:</label><br>
                        <select name="nomeCurso" class="form-control" value="<%= disciplina.getNomeCurso() %>" aria-label="Default select example">
                            <option value="<%= disciplina.getNomeCurso() %>" selected><%= disciplina.getNomeCurso() %></option>
                        </select>
                    <br>						
                  </div>
                <br>                                                               
