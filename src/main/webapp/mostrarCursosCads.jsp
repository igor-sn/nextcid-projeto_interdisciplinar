...
<title>Nextcid | Lista de Cursos</title>
</head>
<!-- id = # / class = . -->
		...
		<div class = "wrapper " style = "min-height : 850px;">
			...
			<div class="container" style="width: 890px;">
				...
				<div class="card" style="width: 650px;">
                        <div class="card-body">
                            <h4 class="card-title"><b>Lista de Cursos</b></h4>                                          
                            <table class="table table-hover">
                                ...
                                lista = (ArrayList)request.getAttribute("cursosList");
                                for(Curso a: lista){%>
                                <tbody>
                                    <tr>
                                    <td><%=a.getIdCurso()%></td>
                                    <td><%=a.getNomeCurso()%></td>
                                    <td><a type="button" class="btn-lg btn-success" style="height: auto; widght: auto; font-size: 13px" href=<%="ServletCurso?cmd=atu&idCurso=".concat(String.valueOf(a.getIdCurso()))%>>Alterar</a></td>
                                    <td><a type="button" class="btn-lg btn-danger" style="height: auto; widght: auto; font-size: 13px" href=<%="ServletCurso?cmd=exc&idCurso=".concat(String.valueOf(a.getIdCurso()))%>>Excluir</a></td>
                                    </tr>
                                    <%
                                    }
                                    %>
