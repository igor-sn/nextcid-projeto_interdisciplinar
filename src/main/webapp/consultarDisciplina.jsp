        ...
        <div class="row">
          <div class="col-sm-8">
            <div class="card" style="height: auto;">
              <div class="card-body">
                <h4 class="card-title">Consultar Disciplina</h4>               
                <form action="ServletDisciplina?cmd=con" method="post">                     
                  <div class="form-inline">
                    <label style="padding:20px">Codigo da Disciplina:</label>
                    <input type="text" class="form-control" name="idDisciplina" style="width:100px;" required>
                  </div>                        
                  <br>                                                                
