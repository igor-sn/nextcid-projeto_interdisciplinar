...
<title>Nextcid | Lista de Disciplinas</title>
</head>
<!-- id = # / class = . -->
		...
		<div class = "wrapper " style = "min-height : 850px;">
			...
			<div class="container" style="width: 890px;">
				...
				<div class="card" style="width: 650px;">
                        <div class="card-body">
                            <h4 class="card-title"><b>Lista de Disciplinas</b></h4>                                          
                            <table class="table table-hover">
                                ...
                                lista = (ArrayList)request.getAttribute("disciplinasList");
                                for(Disciplina a: lista){%>
                                <tbody>
                                    <tr>
                                    <td><%=a.getIdDisciplina()%></td>
                                    <td><%=a.getNomeDisciplina()%></td>
                                    <td><%=a.getNomeCurso()%></td>
                                    <td><a type="button" class="btn-lg btn-success" style="height: auto; widght: auto; font-size: 13px" href=<%="ServletDisciplina?cmd=atu&idDisciplina=".concat(String.valueOf(a.getIdDisciplina()))%>>Alterar</a></td>
                                    <td><a type="button" class="btn-lg btn-danger" style="height: auto; widght: auto; font-size: 13px" href=<%="ServletDisciplina?cmd=exc&idDisciplina=".concat(String.valueOf(a.getIdDisciplina()))%>>Excluir</a></td>
                                    </tr>
                                    <%
                                    }
                                    %>
                            ...
                            <a href="index.jsp" class="btn btn-outline-primary">Pagina Principal</a>                   
                        </div> 
                    </div> 		
                </div>       
            </div>     
