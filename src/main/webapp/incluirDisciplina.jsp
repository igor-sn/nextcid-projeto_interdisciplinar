...
<title>Nextcid | Cadastrar Disciplina</title>
</head>
<!-- id = # / class = . -->
	...
	<div class="parallax">
        ...
        <br><br>
            ...
            <div class="card" style="width:650px;">
              <div class="card-body">
                <h4 class="card-title">Cadastro de Disciplina</h4>               
                ...
                <%
    							...
    							int maiorId = daodisciplina.maiorID();
    							%>                 
                  <div class="form-group" style="text-align: left">
                    <label>Codigo:</label>
                    <input readonly class="form-control" name="idDisciplina" size="60" maxlength="60" value = "<%=maiorId + 1%>"><br>
                    <br>
                    <label>Nome da Disciplina:</label>
                    <input type="text" required class="form-control" name="nomeDisciplina" size="60" maxlength="60"
                    ><br>
                    <label>Curso Relacionado:</label><br>
                        
                        <select name="idCurso" required class="form-control" aria-label="Default select example">
